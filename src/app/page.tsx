...
import { CheckCircle, DollarSign, Headphones, Truck, LayoutDashboard, Wrench, Cpu } from "lucide-react";
...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      carouselItems={[
        ...
        { id: "3", imageSrc: "http://img.b2bpic.net/free-photo/truck-interior-dashboard-steering-wheel_23-2152009003.jpg", imageAlt: "truck cabin technology interior" },
        { id: "4", imageSrc: "http://img.b2bpic.net/free-photo/long-line-semi-trucks-industrial-loading-dock_84443-73903.jpg", imageAlt: "logistics hub aerial view" },
        { id: "5", imageSrc: "http://img.b2bpic.net/free-photo/men-looking-inside-truck-side-view_23-2149426537.jpg", imageAlt: "freight container loading" },
        { id: "6", imageSrc: "http://img.b2bpic.net/free-photo/shipping-logistics-with-truck-airplane-sunset_23-2151998717.jpg", imageAlt: "truck on highway motion blur" },
      ]}
    />
  </div>
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        { id: "1", value: "99%", title: "On-Time Delivery", description: "Consistently meeting strict Amazon Relay schedules.", icon: CheckCircle },
        { id: "2", value: "24/7", title: "Dispatch Support", description: "Always available for route optimization and help.", icon: Headphones },
        { id: "3", value: "500+", title: "Loads Completed", description: "Robust load capacity every single month.", icon: Truck },
        { id: "4", value: "$X,XXX", title: "Weekly Gross", description: "Top-tier earning potential per truck.", icon: DollarSign },
      ]}
  ...
  <div id="team" data-section="team">
      ...
      useInvertedBackground={false}
      members={[
        { id: "1", name: "Sarah Miller", role: "Operations Manager", imageSrc: "http://img.b2bpic.net/free-photo/portrait-businesswoman-manager-talking-coworker-office-sitting-with-laptop_1258-194648.jpg" },
        { id: "2", name: "David Chen", role: "Head of Dispatch", imageSrc: "http://img.b2bpic.net/free-photo/working-businesswoman-taxi_329181-15250.jpg" },
        { id: "3", name: "Marcus Johnson", role: "Fleet Manager", imageSrc: "http://img.b2bpic.net/free-photo/delivery-driver-smiling-white-van_23-2151998675.jpg" },
      ]}
  ...
  <div id="testimonial" data-section="testimonial">
      ...
      avatars={[
        { src: "http://img.b2bpic.net/free-photo/young-male-worker-standing-warehouse_107420-96552.jpg", alt: "truck driver portrait" },
        { src: "http://img.b2bpic.net/free-photo/portrait-handsome-smiling-businessman-work-office_1163-5523.jpg", alt: "logistics dispatcher portrait" },
        { src: "http://img.b2bpic.net/free-photo/portrait-positive-smiling-truck-serviceman-standing-by-truck-vehicle-workshop_342744-1300.jpg", alt: "truck driver confidence" },
        { src: "http://img.b2bpic.net/free-photo/medium-shot-smiley-man-with-helmet_23-2149214310.jpg", alt: "logistics manager professional" },
        { src: "http://img.b2bpic.net/free-photo/man-with-helmet-working-logistic_23-2148886821.jpg", alt: "transportation worker happy" },
      ]}
